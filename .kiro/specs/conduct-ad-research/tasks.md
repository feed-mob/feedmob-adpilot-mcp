...
- [x] 1. Create schemas for ad research data models
  - [x] 1.1 Create `src/schemas/ad-research.ts` with Zod schemas
...
- [x] 2. Create the conduct-ad-research skill plugin
  ...
  - [x] 2.2 Create MCP configuration for web search tools
  ...
  - [x] 2.3 Create SKILL.md with research workflow instructions
  ...
  - [x] 2.4 Update marketplace.json with plugin registration
...
- [x] 3. Create the ad research agent service
  - [x] 3.1 Create `src/services/ad-research-agent.ts`
...
- [x] 4. Create the UI factory for research reports
  - [x] 4.1 Create `src/utils/ad-research-ui.ts` with report UI
  ...
  - [x] 4.2 Implement error UI in `src/utils/ad-research-ui.ts`
...
- [x] 6. Create the MCP tool for conducting ad research
  - [x] 6.1 Create `src/tools/conduct-ad-research.ts`
  ...
  - [x] 6.2 Register tool in FastMCP server
